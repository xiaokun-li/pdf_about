...
def extract_text_from_pdf_by_regions(pdf_filepath):
    ...
    data_dict['consignee'] = data_dict.get("consignee")[20:]
    ...
    sku = data_dict.get("sku_coo_qty").split('^')[0].strip()
...
if __name__ == '__main__':
    pdf_filepath = r'C:\Users\xman\Desktop\invs1\1917949_0811268708_CI_EC.pdf'
